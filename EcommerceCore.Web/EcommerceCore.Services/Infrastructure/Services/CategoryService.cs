...
namespace EcommerceCore.Services.Infrastructure.Services
{
    public class CategoryService: EntityService<Category>, ICategoryService
    {
        ...
        {
            return _categoryRepository.GetMaxOrderDisplay();
        }

        public async Task<ICollection<Category>> GetSubCategoryById(Guid id)
        {
            // return await _categoryRepository.FindAllAsync(o => o.ParentId == id);
            return  await _categoryRepository.GetSubCategoryById(id);
        }
